package rtx.vexsiko.utils.render.warmup;
...
public final class Render2DWarmup {
    ...
    public static void runWarmupFrame(DrawContext drawContext) {
        ...
        Fonts.VEXSIKO.msdf("pjri", -20.0f, 0.0f, 6.5f, 0x1FFFFFF);
        ...
        GifRenderer.draw(drawContext, -20.0f, 0.0f, 2.0f, 2.0f, 1.0f, "vexsiko:gif/kity.gif", 0.003921569f);
