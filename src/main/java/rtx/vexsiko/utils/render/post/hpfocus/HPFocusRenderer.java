package rtx.vexsiko.utils.render.post.hpfocus;
...
public final class HPFocusRenderer {
    public static final String TEXTURE_KEY = "vexsiko:hpfocus_scene";
    private static final Identifier TEXTURE_ID = Identifier.of((String)"vexsiko", (String)"hpfocus_scene");
    private static final Identifier PIPELINE_ID = Identifier.of((String)"vexsiko", (String)"pipeline/post/hpfocus/copy");
    private static final Identifier COPY_SHADER = Identifier.of((String)"vexsiko", (String)"post/hpfocus/copy");
    ...
    private static boolean ensureInitialized() {
        ...
        try {
            ...
            pipeline = null;
            VexSiko.LOGGER.error("[HPFocus] failed to initialise copy pipeline", throwable);
            return false;
        }
    }
    ...
    public static void captureIfRequested() {
        ...
        try {
            ...
            try (RenderPass renderPass = commandEncoder.createRenderPass(() -> "vexsiko:hpfocus_copy", outTarget.getColorAttachmentView(), OptionalInt.empty());){
            ...
            VexSiko.LOGGER.error("[HPFocus] scene capture failed, disabling", throwable);
        }
    }
    ...
    private static void ensureResources(int n, int n2) {
        ...
        HPFocusRenderer.closeResources();
        sceneCopyTexture = RenderSystem.getDevice().createTexture(() -> "vexsiko:hpfocus_scene_copy", 5, TextureFormat.RGBA8, n, n2, 1, 1);
