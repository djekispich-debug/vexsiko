...
import rtx.vexsiko.utils.render.renderitem.CustomItemRenderer;
import rtx.vexsiko.utils.render.renderitem.RenderItemOptions;
...
public final class RenderItem {
    ...
    public static void close() {
        ...
        VexSiko.LOGGER.info("[RenderItem] RenderItem closed");
    }

    public static void init() {
        RenderItem.registerReloadListener();
        VexSiko.LOGGER.info("[RenderItem] RenderItem initialized");
    }
    ...
    private static void registerReloadListener() {
        ...
        Identifier identifier = Identifier.of((String)"vexsiko", (String)"render_item_cache");
