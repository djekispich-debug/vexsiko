package rtx.vexsiko.utils.render.wings;
...
public final class WingsShaderRenderer {
    ...
    public static void render(Matrix4f modelView, boolean depth) {
        ...
        float resX = mc.getWindow().getFramebufferWidth();
        float resY = mc.getWindow().getFramebufferHeight();
    ...
    private static void initPipeline() {
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("vexsiko", "pipeline/world/wings_shader"))
                    .withVertexShader(Identifier.of("vexsiko", "world/wings_shader/wings_shader"))
                    .withFragmentShader(Identifier.of("vexsiko", "world/wings_shader/wings_shader"))
