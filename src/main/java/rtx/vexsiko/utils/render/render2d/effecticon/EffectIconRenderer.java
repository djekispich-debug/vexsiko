package rtx.vexsiko.utils.render.render2d.effecticon;
...
import rtx.vexsiko.utils.render.render2d.effecticon.EffectIconQuad;
import rtx.vexsiko.utils.render.render2d.effecticon.EffectIconRenderState;
import rtx.vexsiko.utils.render.render2d.effecticon.EffectIconTexture;
...
implements AutoCloseable {
    ...
    private void submit(DrawContext drawContext, BuiltEffectIcon builtEffectIcon) {
        ...
        try {
            ...
            VexSiko.LOGGER.warn("[EffectIconRenderer] Failed to submit effect icon", (Throwable)runtimeException);
        }
    }
