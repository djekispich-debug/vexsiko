...
implements AutoCloseable {
    ...
    private static final String FONT_ROOT = "/assets/vexsiko/fonts/";
    ...
    private Font loadFont(String string, Font font) {
        try (InputStream inputStream = FontManager.class.getResourceAsStream(FONT_ROOT + string);){
            if (inputStream == null) {
                VexSiko.LOGGER.debug("[FontRenderer] Font asset not found, using fallback: {}", (Object)string);
                return font;
            }
            ...
            VexSiko.LOGGER.warn("[FontRenderer] Failed to load font asset: {}", (Object)string, (Object)exception);
            return font;
        }
    }
