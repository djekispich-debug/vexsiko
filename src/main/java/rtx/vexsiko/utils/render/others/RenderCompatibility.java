package rtx.vexsiko.utils.render.others;
...
public final class RenderCompatibility {
    ...
    private static final String SAFE_WORLD_EFFECTS_PROPERTY = "vexsiko_safeWorldEffects";
    private static final String SAFE_WORLD_EFFECTS_ENV = "VEXSIKO_SAFE_WORLD_EFFECTS";
    private static Boolean disableFragEffectScanShader;
    private static String disableFragEffectScanShaderReason;
    private static final String DISABLE_FRAG_EFFECT_SCAN_PROPERTY = "vexsiko_disableFragEffectScanShader";
    private static final String DISABLE_FRAG_EFFECT_SCAN_ENV = "VEXSIKO_DISABLE_FRAG_EFFECT_SCAN_SHADER";
