package rtx.vexsiko.utils.chat;
...
public final class ChatMessage {
    private static final String PREFIX_STR = "[VexSiko] ";

    public static MutableText brandmessage() {
        return Text.literal("[VexSiko] ").formatted(Formatting.DARK_PURPLE, Formatting.BOLD);
    }
