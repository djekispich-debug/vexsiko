...
import rtx.vexsiko.mixin.accessor.BossHealthOverlayAccessor;
...
public final class Network {
    ...
    private static void updatePvpState(long l) {
        ...
        Map<UUID, ClientBossBar> map = ((BossHealthOverlayAccessor)Network.MC.inGameHud.getBossBarHud()).vexsiko_getEvents();
