...
import rtx.vexsiko.mixin.accessor.MultiPlayerGameModeAccessor;
...
import rtx.vexsiko.utils.render.world.BlockOverlayRenderer;
...
extends Module {
    ...
    private void onTick(TickEvent tickEvent) {
        ...
        BlockPos blockPos = multiPlayerGameModeAccessor.vexsiko_getDestroyBlockPos();
        float f = multiPlayerGameModeAccessor.vexsiko_getDestroyProgress();
        boolean bl = multiPlayerGameModeAccessor.vexsiko_isDestroying() || f > 0.0f && f != this.previousRawProgress;
