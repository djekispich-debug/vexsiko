...
import rtx.vexsiko.api.drags.RenderUnderHand;
...
import rtx.vexsiko.utils.render.render2d.msdf.GlyphNormalizer;
import rtx.vexsiko.utils.render.render2d.msdf.MsdfFont;
import rtx.vexsiko.utils.render.render2d.msdf.MsdfFonts;
import rtx.vexsiko.utils.render.underhand.UnderHand2D;
...
extends Module {
    ...
    private static final String ICON_FONT = "vexsiko";
    ...
    private void onWorldRender(WorldRenderEvent worldRenderEvent) {
        ...
        for (PlayerEntity playerEntity : this.mc.world.getPlayers()) {
            ...
            boolean bl4 = bl2 && ClientPresence.INSTANCE.isVexSikoUser(playerEntity.getGameProfile().name());
