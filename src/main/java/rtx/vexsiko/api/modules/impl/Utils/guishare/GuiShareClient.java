...
public final class GuiShareClient {
    ...
    private void applyDelta(JsonArray jsonArray, JsonArray jsonArray2) {
        for (JsonElement jsonElement : jsonArray) {
            ...
            String brand = this.normalize(this.readString(object, "br"), 16);
            if (brand.isBlank()) brand = "kimiko";
            // only accept vexsiko paste - ignore original kimiko and other forks
            if (!brand.equalsIgnoreCase("vexsiko")) continue;
            this.remoteStates.put(string3, new GuiShareRemoteState(string3, string, string2, this.normalize(this.readString(object, "w"), 64), this.readDouble(object, "x", 0.0), this.readDouble(object, "y", 0.0), this.readDouble(object, "z", 0.0), this.readBoolean(object, "o"), new Vec3d(this.readDouble(object, "ax", 0.0), this.readDouble(object, "ay", 0.0), this.readDouble(object, "az", 0.0)), (float)this.readDouble(object, "ry", 0.0), (float)this.readDouble(object, "rp", 0.0), this.normalize(this.readString(object, "c"), 32), Math.max(0, Math.min(1, (int)this.readDouble(object, "es", 0.0))), (float)this.readDouble(object, "ec", 0.0), (float)this.readDouble(object, "sc", 0.0), (float)this.readDouble(object, "mx", 0.0), (float)this.readDouble(object, "my", 0.0), this.normalize(this.readString(object, "pm"), 32), (float)this.readDouble(object, "ps", 0.0), (float)this.readDouble(object, "px", 0.0), (float)this.readDouble(object, "py", 0.0), list, this.normalize(this.readString(object, "q"), 32), arrayList, this.normalize(this.readString(object, "ro"), 24), this.normalize(this.readString(object, "av"), 160), guiShareCloseState, GuiShareThemeState.fromJson(object), this.normalize(this.readString(object, "th"), 32), (float)this.readDouble(object, "hs", 0.0), brand));
        }
    ...
    private void sendPacket(String string) {
        ...
        jsonObject.addProperty("br", "vexsiko");
