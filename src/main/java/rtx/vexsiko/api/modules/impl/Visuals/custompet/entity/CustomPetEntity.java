package rtx.vexsiko.api.modules.impl.Visuals.custompet.entity;
...
import rtx.vexsiko.api.mods.geckolib.animatable.GeoEntity;
import rtx.vexsiko.api.mods.geckolib.animatable.instance.AnimatableInstanceCache;
import rtx.vexsiko.api.mods.geckolib.animatable.manager.AnimatableManager;
import rtx.vexsiko.api.mods.geckolib.animatable.manager.AnimatableManager.ControllerRegistrar;
import rtx.vexsiko.api.mods.geckolib.animation.AnimationController;
...
import rtx.vexsiko.api.mods.geckolib.util.GeckoLibUtil;
import rtx.vexsiko.api.modules.impl.Visuals.custompet.CustomPetVariant;
import rtx.vexsiko.api.modules.impl.Visuals.custompet.sync.CustomPetRemoteState;
...
implements GeoEntity {
    ...
    private static void resolveSounds() {
        ...
        soundsResolved = true;
        try {
            ambientSound = SoundEvent.of((Identifier)Identifier.of((String)"vexsiko", (String)"entity.ribbit.ambient"));
            stepSound = SoundEvent.of((Identifier)Identifier.of((String)"vexsiko", (String)"entity.ribbit.step"));
        }
