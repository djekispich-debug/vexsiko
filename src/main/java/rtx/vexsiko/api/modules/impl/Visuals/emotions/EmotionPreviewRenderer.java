...
import rtx.vexsiko.api.modules.impl.Visuals.emotions.EmotionPlayback;
import rtx.vexsiko.api.modules.impl.Visuals.emotions.EmotionPreviewState;
import rtx.vexsiko.mixin.emotions.PictureInPictureRendererAccessor;
...
extends SpecialGuiElementRenderer<EmotionPreviewState> {
    ...
    protected String getName() {
        return "vexsiko emotion previews";
    }
    ...
    protected void blitTexture(EmotionPreviewState emotionPreviewState, GuiRenderState guiRenderState) {
        GpuTextureView gpuTextureView = ((PictureInPictureRendererAccessor)((Object)this)).vexsiko_textureView();
