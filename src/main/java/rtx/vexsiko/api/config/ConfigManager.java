package rtx.vexsiko.api.config;
...
import rtx.vexsiko.api.drags.Draggable;
import rtx.vexsiko.api.events.EventBus;
import rtx.vexsiko.api.events.impl.game.TickEvent;
import rtx.vexsiko.api.events.impl.module.ModuleToggleEvent;
...
import rtx.vexsiko.api.modules.settings.impl.BindSetting;
import rtx.vexsiko.api.modules.settings.impl.BindSetting.Type;
...
import rtx.vexsiko.api.modules.settings.impl.PositionSettings;
import rtx.vexsiko.api.modules.settings.impl.SelectSetting;
import rtx.vexsiko.api.modules.settings.impl.SliderSetting;
import rtx.vexsiko.api.modules.settings.impl.TextSetting;
...
public final class ConfigManager {
    ...
    private static final String CONFIG_EXTENSION = ".vexsiko";
        ...
        block13: {
            ...
            if (!Files.exists(configPath)) {
                ...
                if (Files.exists(triaPath)) {
                    ...
                    Path jsonPath = FabricLoader.getInstance().getGameDir().resolve("vexsiko").resolve("autocfg.json");
            ...
            try (BufferedReader reader = Files.newBufferedReader(configPath)) {
                ...
                VexSiko.LOGGER.error("[ConfigManager] Failed to read module config", (Throwable)exception);
                return new JsonObject();
            }
        }
        return jsonObject;
    ...
    private static Path moduleConfigPath() {
        return RepositoryStorage.root().resolve("autocfg.vexsiko");
    }
    ...
    private static void saveModules(boolean bl) {
        ...
        try {
            ...
            VexSiko.LOGGER.error("[ConfigManager] Failed to save module config", (Throwable)exception);
        }
    }
    ...
    public static List<String> listProfiles() {
        ...
        try (Stream<Path> stream = Files.list(path2);){
            ...
            VexSiko.LOGGER.error("[ConfigManager] Failed to list profiles", (Throwable)exception);
        }
    ...
    public static void saveProfile(String string) {
        ...
        try {
            ...
            VexSiko.LOGGER.error("[ConfigManager] Failed to save profile {}", (Object)string, (Object)exception);
        }
    }
    ...
    public static void loadProfile(String string) {
        ...
        try (BufferedReader bufferedReader = Files.newBufferedReader(path);){
            ...
            VexSiko.LOGGER.error("[ConfigManager] Failed to load profile {}", (Object)string, (Object)exception);
        }
        finally {
            ConfigManager.INSTANCE.loading = false;
        }
    ...
    private static void resetSetting(Setting setting) {
        try {
            ...
            VexSiko.LOGGER.warn("[ConfigManager] Failed to reset setting {}", (Object)setting.getName(), (Object)exception);
        }
    }
    ...
    public static void deleteProfile(String string) {
        try {
            ...
            VexSiko.LOGGER.error("[ConfigManager] Failed to delete profile {}", (Object)string, (Object)exception);
        }
    }
    ...
    private static void applySetting(Setting setting, JsonElement jsonElement) {
        try {
            ...
            VexSiko.LOGGER.warn("[ConfigManager] Failed to apply setting {}", (Object)setting.getName(), (Object)exception);
        }
    }
    ...
    public static void resetToFactory() {
        ConfigManager.INSTANCE.loading = true;
        try {
            ThemeManager.set(Theme.VEXSIKO);
        ...
        try {
            ...
            VexSiko.LOGGER.error("[ConfigManager] Failed to delete active config during reset", (Throwable)exception);
        }
        ConfigManager.saveModules(true);
    }
