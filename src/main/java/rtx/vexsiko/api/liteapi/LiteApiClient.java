package rtx.vexsiko.api.liteapi;
...
import rtx.vexsiko.api.liteapi.FeatureBlocklist;
import rtx.vexsiko.api.liteapi.LiteApiCodec;
import rtx.vexsiko.api.liteapi.LiteApiCodec.Request;
import rtx.vexsiko.api.liteapi.packets.LiteApiPayload;

public final class LiteApiClient {
    public static final LiteApiClient INSTANCE = new LiteApiClient();
    private static final String CLIENT_ID = "vexsiko";
    ...
    private void handle(String string) {
        ...
        if (incoming == null) {
            VexSiko.LOGGER.warn("[LiteAPI] \u041f\u043e\u043b\u0443\u0447\u0435\u043d \u043d\u0435\u0432\u0430\u043b\u0438\u0434\u043d\u044b\u0439 \u043f\u0430\u043a\u0435\u0442 (\u043d\u0435 JSON-\u043e\u0431\u044a\u0435\u043a\u0442)");
            return;
        }
        if (incoming.isPushEvent()) {
            VexSiko.LOGGER.debug("[LiteAPI] push-\u0441\u043e\u0431\u044b\u0442\u0438\u0435: {}", (Object)incoming.event());
            return;
        }
        ...
        if (!incoming.ok()) {
            ...
            VexSiko.LOGGER.warn("[LiteAPI] checkFeatures \u043e\u0448\u0438\u0431\u043a\u0430 {}{}", (Object)string2, (Object)string3);
            return;
        }
        ...
        if (MinecraftClient.getInstance() != null && !list.isEmpty()) {
            VexSiko.LOGGER.info("[LiteAPI] \u0421\u0435\u0440\u0432\u0435\u0440 \u0437\u0430\u0431\u043b\u043e\u043a\u0438\u0440\u043e\u0432\u0430\u043b \u0444\u0438\u0447\u0438: {}", list);
        }
    }
    ...
    private void onJoin() {
        ...
        try {
            ...
            VexSiko.LOGGER.warn("[LiteAPI] \u041d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u043e\u0442\u043f\u0440\u0430\u0432\u0438\u0442\u044c checkFeatures: {}", (Object)runtimeException.toString());
        }
    }
}
