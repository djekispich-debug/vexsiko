package rtx.vexsiko.api.mods.geckolib.animation;
...
import rtx.vexsiko.api.mods.geckolib.animatable.manager.AnimatableManager;
import rtx.vexsiko.api.mods.geckolib.animation.RawAnimation;
import rtx.vexsiko.api.mods.geckolib.animation.object.EasingType;
import rtx.vexsiko.api.mods.geckolib.animation.object.PlayState;
import rtx.vexsiko.api.mods.geckolib.animation.state.AnimationPoint;
import rtx.vexsiko.api.mods.geckolib.animation.state.AnimationTest;
import rtx.vexsiko.api.mods.geckolib.animation.state.AnimationTimeline;
import rtx.vexsiko.api.mods.geckolib.animation.state.AnimationTimeline.Stage;
...
import rtx.vexsiko.api.mods.geckolib.cache.animation.keyframeevent.CustomInstructionKeyframeData;
import rtx.vexsiko.api.mods.geckolib.cache.animation.keyframeevent.ParticleKeyframeData;
import rtx.vexsiko.api.mods.geckolib.cache.animation.keyframeevent.SoundKeyframeData;
import rtx.vexsiko.api.mods.geckolib.loading.math.MolangQueries;
import rtx.vexsiko.api.mods.geckolib.loading.math.MolangQueries.Actor;
...
import rtx.vexsiko.api.mods.geckolib.util.ClientUtil;
...
public class AnimationController<T extends GeoAnimatable> {
    ...
    public static interface KeyframeEventHandler<A extends GeoAnimatable, E> {
        public void handle(rtx.vexsiko.api.mods.geckolib.animation.state.KeyFrameEvent<A, E> var1);
    }
}
