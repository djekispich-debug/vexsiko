...
import rtx.vexsiko.api.mods.geckolib.renderer.base.PerBoneRender;
import rtx.vexsiko.api.mods.geckolib.renderer.base.RenderPassInfo;
import rtx.vexsiko.api.mods.geckolib.renderer.layer.GeoRenderLayer;
import rtx.vexsiko.api.mods.geckolib.util.ClientUtil;
import rtx.vexsiko.api.mods.geckolib.util.RenderUtil;

public interface GeoRendererInternals<T extends rtx.vexsiko.api.mods.geckolib.animatable.GeoAnimatable, O, R extends GeoRenderState> {
