package rtx.vexsiko.api.mods.chathads;
...
import rtx.vexsiko.api.mods.chathads.ComponentProcessor;
import rtx.vexsiko.api.mods.chathads.HeadData;
import rtx.vexsiko.api.mods.chathads.config.ChatHeadsConfig;
import rtx.vexsiko.api.mods.chathads.config.ChatHeadsConfigDefaults;
import rtx.vexsiko.api.mods.chathads.config.RenderPosition;
import rtx.vexsiko.api.mods.chathads.config.SenderDetection;
import rtx.vexsiko.api.mods.chathads.mixininterface.HeadRenderable;
import rtx.vexsiko.api.mods.chathads.mixininterface.Ownable;
