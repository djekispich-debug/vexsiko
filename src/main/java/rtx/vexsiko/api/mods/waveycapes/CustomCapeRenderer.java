...
import rtx.vexsiko.api.mods.waveycapes.NMSUtil;
import rtx.vexsiko.api.mods.waveycapes.VanillaCapeRenderer;
import rtx.vexsiko.api.mods.waveycapes.WaveyCapesBase;
import rtx.vexsiko.api.mods.waveycapes.compat.MathUtil;
import rtx.vexsiko.api.mods.waveycapes.compat.PlayerWrapper;
import rtx.vexsiko.api.mods.waveycapes.compat.VertexConsumerUtil;
import rtx.vexsiko.api.mods.waveycapes.support.ModSupport;
import rtx.vexsiko.api.mods.waveycapes.support.SupportManager;
import rtx.vexsiko.api.mods.waveycapes.versionless.CapeHolder;
import rtx.vexsiko.api.mods.waveycapes.versionless.CapeMovement;
import rtx.vexsiko.api.mods.waveycapes.versionless.CapeStyle;
import rtx.vexsiko.api.mods.waveycapes.versionless.ModBase;
import rtx.vexsiko.api.mods.waveycapes.versionless.sim.BasicSimulation;
import rtx.vexsiko.api.mods.waveycapes.versionless.util.Vector3;
import rtx.vexsiko.api.mods.waveycapes.versionless.util.Vector4;
