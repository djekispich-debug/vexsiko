...
import rtx.vexsiko.api.drags.DragController;
import rtx.vexsiko.api.drags.Draggable;
import rtx.vexsiko.api.drags.HudSettingsPanel;
import rtx.vexsiko.api.drags.MitosisController;
import rtx.vexsiko.api.drags.MitosisController.SplitDraw;
import rtx.vexsiko.api.drags.Position;
import rtx.vexsiko.api.drags.SplitRectComp;
import rtx.vexsiko.api.drags.components.ArmorComp;
import rtx.vexsiko.api.drags.components.ArrayListComp;
import rtx.vexsiko.api.drags.components.CooldownsComp;
import rtx.vexsiko.api.drags.components.HPFocusComp;
import rtx.vexsiko.api.drags.components.HotKeysComp;
import rtx.vexsiko.api.drags.components.InventoryComp;
import rtx.vexsiko.api.drags.components.KeyStrokesComp;
import rtx.vexsiko.api.drags.components.PotionsComp;
import rtx.vexsiko.api.drags.components.TargetHudComp;
import rtx.vexsiko.api.drags.components.WatermarkComp;
import rtx.vexsiko.api.drags.hud.InfoHud;
import rtx.vexsiko.api.events.EventBus;
import rtx.vexsiko.api.events.impl.game.CloseScreenEvent;
...
import rtx.vexsiko.utils.render.post.hitbubbles.HitBubblesRenderer;
...
public final class DragSystem {
    ...
    private void handleRenderFailure(Draggable draggable, Throwable throwable) {
        ...
        if (this.renderFailures.add(string)) {
            VexSiko.LOGGER.error("[DragSystem] Component {} failed to render and was isolated", (Object)string, (Object)throwable);
        }
    }
