package rtx.vexsiko.api.chat.commands;
...
import rtx.vexsiko.api.chat.commands.impl.BindCommand;
import rtx.vexsiko.api.chat.commands.impl.ConfigCommand;
import rtx.vexsiko.api.chat.commands.impl.AltCommand;
import rtx.vexsiko.api.chat.commands.impl.FriendCommand;
import rtx.vexsiko.api.chat.commands.impl.HelpCommand;
import rtx.vexsiko.api.chat.commands.impl.IrcCommand;
import rtx.vexsiko.api.chat.commands.impl.MacroCommand;
import rtx.vexsiko.api.chat.commands.impl.PartyChatCommand;
import rtx.vexsiko.api.chat.commands.impl.PartyCommand;
import rtx.vexsiko.api.chat.commands.impl.PrefixCommand;
import rtx.vexsiko.api.chat.commands.impl.ViewModelCommand;
import rtx.vexsiko.api.chat.commands.impl.KillEffectButton;
...
public final class CommandManager {
    ...
    public void init() {
        ...
        this.register(new AltCommand());
        this.register(new KillEffectButton());
        VexSiko.LOGGER.info("[CommandManager] Initialized with {} commands, prefix '{}'", (Object)this.commands.size(), (Object)this.prefix);
    }
    ...
    public void executeRaw(String string) {
        ...
        try {
            ...
            VexSiko.LOGGER.error("[CommandManager] Error executing command '{}'", (Object)string2, (Object)exception);
        }
    }
