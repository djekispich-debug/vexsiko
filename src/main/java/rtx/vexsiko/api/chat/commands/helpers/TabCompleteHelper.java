package rtx.vexsiko.api.chat.commands.helpers;
...
public class TabCompleteHelper {
    ...
    public TabCompleteHelper addCommands(rtx.vexsiko.api.chat.commands.CommandManager cm) {
        if (cm != null) {
            for (rtx.vexsiko.api.chat.commands.Command c : cm.getCommands()) {
