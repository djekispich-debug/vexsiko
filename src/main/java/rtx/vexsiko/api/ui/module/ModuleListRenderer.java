package rtx.vexsiko.api.ui.module;
...
import rtx.vexsiko.api.ui.ScrollBar;
...
public final class ModuleListRenderer {
    ...
    public void warmup() {
        ...
        for (Category category : Category.values()) {
            for (Module module : this.getModules(category)) {
                ...
                Fonts.VEXSIKO.msdf(ICON_CACHE.get((Object)category), -500.0f, -500.0f, 6.5f, n);
        ...
        Fonts.VEXSIKO.msdf(GEAR_GLYPH, -500.0f, -500.0f, 7.0f, n);
    ...
    public boolean hitSettingsIcon(float f, float f2, float f3, float f4, float f5, Module module) {
        ...
        float f7 = Fonts.VEXSIKO.msdfWidth(GEAR_GLYPH, 7.0f);
        float f8 = f6 - 7.0f - f7;
    ...
    private void renderCards(DrawContext drawContext, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, List<Module> list, boolean bl) {
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            if (!module.getSettings().all().isEmpty()) {
                ...
                float f40 = Fonts.VEXSIKO.msdfWidth(GEAR_GLYPH, 7.0f);
                ...
                Fonts.VEXSIKO.msdf(GEAR_GLYPH, f41, f42, 7.0f, n8);
            }
            if (!bl6) continue;
