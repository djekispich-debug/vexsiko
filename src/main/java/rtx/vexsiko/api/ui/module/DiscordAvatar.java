...
public final class DiscordAvatar {
    ...
    private static void upload(BufferedImage bufferedImage) {
        try {
            ...
            GpuTexture gpuTexture = RenderSystem.getDevice().createTexture(() -> "vexsiko_discord_avatar_" + avatarId, 5, TextureFormat.RGBA8, n2, n3, 1, 1);
            ...
            nativeImage.close();
            Identifier identifier = Identifier.of((String)"vexsiko", (String)("discord/avatar_" + avatarId));
    ...
    private static void startDownload(String string) {
        ...
        Thread thread = new Thread(() -> {
            try {
                ...
                uRLConnection.setRequestProperty("User-Agent", "Mozilla/5.0 (VexSiko)");
