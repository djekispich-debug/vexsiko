...
implements Setting {
    ...
    private final rtx.vexsiko.api.modules.settings.impl.TextSetting backend;

    public TextSetting(rtx.vexsiko.api.modules.settings.impl.TextSetting textSetting) {
