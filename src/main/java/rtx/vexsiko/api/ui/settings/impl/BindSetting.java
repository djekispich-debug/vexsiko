...
implements Setting {
    private final rtx.vexsiko.api.modules.settings.impl.BindSetting backend;
    private boolean listening;

    public BindSetting(rtx.vexsiko.api.modules.settings.impl.BindSetting bindSetting) {
