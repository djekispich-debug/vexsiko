...
implements Setting {
    private final rtx.vexsiko.api.modules.settings.impl.SliderSetting backend;
    ...
    public SliderSetting(rtx.vexsiko.api.modules.settings.impl.SliderSetting sliderSetting) {
