...
implements Setting {
    private final rtx.vexsiko.api.modules.settings.impl.ColorSetting backend;
    ...
    public ColorSetting(rtx.vexsiko.api.modules.settings.impl.ColorSetting colorSetting) {
