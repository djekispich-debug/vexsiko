package rtx.vexsiko.api.ui.settings.impl;
...
implements Setting {
    private final rtx.vexsiko.api.modules.settings.impl.MultiSelectSetting backend;
    private boolean open;
    private final Decelerate dropAnim;

    public MultiSelectSetting(rtx.vexsiko.api.modules.settings.impl.MultiSelectSetting multiSelectSetting) {
