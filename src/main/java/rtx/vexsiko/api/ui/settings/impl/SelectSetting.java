...
implements Setting {
    ...
    private final rtx.vexsiko.api.modules.settings.impl.SelectSetting backend;
    ...
    public SelectSetting(rtx.vexsiko.api.modules.settings.impl.SelectSetting selectSetting) {
