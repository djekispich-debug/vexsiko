...
implements Setting {
    ...
    private final rtx.vexsiko.api.modules.settings.impl.SeparatorSetting backend;

    public SeparatorSetting(rtx.vexsiko.api.modules.settings.impl.SeparatorSetting separatorSetting) {
