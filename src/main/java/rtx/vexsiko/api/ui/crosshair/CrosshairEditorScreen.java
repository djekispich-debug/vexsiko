...
extends BaseScreen {
    ...
    private static void initToggleAnim(Decelerate anim, boolean val) {
        if (anim != null) {
            anim.setDirection(val ? rtx.vexsiko.utils.animations.Direction.FORWARDS : rtx.vexsiko.utils.animations.Direction.BACKWARDS);
        }
    }
}
