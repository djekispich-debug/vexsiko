...
public final class ThemeManager {
    ...
    private static Theme current = Theme.VEXSIKO;
    private static int[] currentShades = Theme.VEXSIKO.shades();
    private static float[] fromShades = ThemeManager.unpack(Theme.VEXSIKO.shades());
    private static int[] fromPalette = Theme.VEXSIKO.palette();
