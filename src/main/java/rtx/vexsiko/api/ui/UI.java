...
import rtx.vexsiko.api.events.impl.input.MouseButtonEvent.Action;
...
import rtx.vexsiko.api.modules.impl.Utils.guishare.GuiShareCloseState;
import rtx.vexsiko.api.modules.impl.Utils.guishare.GuiShareLocalSnapshot;
import rtx.vexsiko.api.modules.impl.Utils.guishare.GuiSharePopupRow;
import rtx.vexsiko.api.modules.impl.Utils.guishare.GuiShareThemeState;
...
import rtx.vexsiko.api.ui.BindPopup;
import rtx.vexsiko.api.ui.SettingsPopup;
import rtx.vexsiko.api.ui.social.SocialRenderer;
import rtx.vexsiko.api.ui.module.DiscordAvatar;
import rtx.vexsiko.api.ui.module.ModuleListRenderer;
import rtx.vexsiko.api.ui.module.SearchField;
import rtx.vexsiko.api.ui.settings.RenderHelper;
...
import rtx.vexsiko.api.ui.theme.ThemesRenderer;
...
import rtx.vexsiko.utils.animations.Decelerate;
import rtx.vexsiko.utils.animations.Direction;
import rtx.vexsiko.utils.animations.GuiMotionAnimation;
...
import rtx.vexsiko.utils.render.post.guilayerblur.GuiCapture.Source;
...
import rtx.vexsiko.utils.sounds.Sounds;

public class UI
extends BaseScreen
implements GuiCapture.Source {
    private static final String[] EVENT_SUBS = new String[]{"Online", "Friends"};
    ...
    private static final Category[] MAIN_CATEGORIES = new Category[]{Category.VISUALS, Category.DISPLAY, Category.UTILS, Category.FRIENDS};
    ...
    private final SocialRenderer eventsRenderer = new SocialRenderer();
    ...
    private void renderNoCategoryPlaceholder(DrawContext drawContext, float f, float f2, float f3, float f4) {
        ...
        GifRenderer.draw(drawContext, f10, f11, f9, f9, 8.0f, "vexsiko:gif/kity.gif", f4);
    ...
    private static char iconChar(Category category) {
        return switch (category) {
            ...
            case Category.ONLINE -> 'b';
            case Category.FRIENDS -> 'm';
    ...
    private void renderCategoryPanel(float f, float f2, float f3, float f4) {
        ...
        float f18 = Fonts.VEXSIKO.msdfWidth(string, f15);
        float f19 = Fonts.SMALL_PIXEL.msdfWidth("VEXSIKO", f16);
        float f20 = f9 + (f10 - (f18 + f17 + f19)) * 0.5f;
        AccentGradient.msdfIcon("vexsiko", string, f20, f14 - f15 * 0.5f + 0.5f, f15, 225.0f * f4, 0.1f);
        Fonts.SMALL_PIXEL.msdf("VEXSIKO", f20 + f18 + f17, f14 - f16 * 0.5f + 0.5f, f16, UI.color(255, 255, 255, 255, f4));
        float f21 = f2 + 34.0f;
        float f22 = f21 + 10.0f;
        ...
        String string2 = "h";
        float f24 = Fonts.VEXSIKO.msdfWidth(string2, 8.0f);
        AccentGradient.msdfIcon("vexsiko", string2, f11, f22 - 4.0f + 1.5f, 8.0f, (200.0f + 55.0f * f23) * f4, 0.15f);
        ...
        for (int i = 0; i < MAIN_CATEGORIES.length; ++i) {
            ...
            float f32 = Fonts.VEXSIKO.msdfWidth(string3, 7.0f);
            if (f7 > 0.01f) {
            ...
            AccentGradient.msdfIcon("vexsiko", string3, f27, f31 - 3.5f + 1.5f - f30, 7.0f, (float)n2 * f4, f6);
        ...
        String string5 = "e";
        f7 = Fonts.VEXSIKO.msdfWidth(string5, 8.0f);
        AccentGradient.msdfIcon("vexsiko", string5, f11, f34 - 4.0f + 1.5f, 8.0f, (200.0f + 55.0f * f8) * f4, 0.6f);
        ...
        for (int i = 0; i < EVENT_SUBS.length; ++i) {
            ...
            float f39 = Fonts.VEXSIKO.msdfWidth(string6, 7.0f);
            if (f5 > 0.01f) {
            ...
            AccentGradient.msdfIcon("vexsiko", string6, f27, f38 - 3.5f + 1.5f - f30, 7.0f, (float)n4 * f4, 0.6f);
        ...
        for (int i = 0; i < OTHER_CATEGORIES.length; ++i) {
            ...
            float f45 = Fonts.VEXSIKO.msdfWidth(string7, 7.5f);
            AccentGradient.msdfIcon("vexsiko", string7, f11, f43 - 3.75f + 1.5f - f30, 7.5f, (float)n6 * f4, 0.85f);
