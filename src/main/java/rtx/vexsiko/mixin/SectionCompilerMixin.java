...
import rtx.vexsiko.utils.render.wave.WindWaveTagger;
...
public class SectionCompilerMixin {
    ...
    private void vexsiko_tagWavingVertices(BlockRenderManager dispatcher, BlockState state, BlockPos pos, BlockRenderView level, MatrixStack poseStack, VertexConsumer consumer, boolean checkSides, List<BlockModelPart> parts, Operation<Void> original) {
