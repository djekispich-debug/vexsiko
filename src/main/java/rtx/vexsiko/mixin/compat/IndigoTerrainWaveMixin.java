package rtx.vexsiko.mixin.compat;
...
public abstract class IndigoTerrainWaveMixin {
    ...
    private VertexConsumer vexsiko_tagIndigoVertices(AbstractTerrainRenderContext instance, BlockRenderLayer layer, Operation<VertexConsumer> original) {
