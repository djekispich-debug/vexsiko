package rtx.vexsiko.stolen.godweer;

// STOLEN: auto-generated stub, original file: D:/Downloads/GodWeer/GodWeer/src/main/java/gg/godweer/vse/utils/render/impl/KawaseBlurPipeline.java
// Original package remapped to rtx.vexsiko.stolen.godweer and class KawaseBlurPipeline -> StolenKawaseBlurPipeline
...
import rtx.vexsiko.stolen.wings.StolenClientPipelines; // STOLEN: remapped from gg.godweer.api.render.system.StolenClientPipelines
 ...
 *_/
public class StolenKawaseBlurPipeline {
    ...
    public GpuTextureView blur(GpuTexture sourceTexture, GpuTextureView sourceView, int w, int h, int iterations, float offset) {
        ...
        for (int i = 0; i < iterations; i++) {
            uploadPass(
                    encoder,
                    StolenClientPipelines.KAWASE_DOWN_PIPELINE,
                    currentSource,
                    downViews[i],
                    currentWidth,
                    currentHeight,
                    offset,
                    "godweer:kawase_down_" + i
            );
        ...
        for (int i = iterations - 1; i >= 0; i--) {
            uploadPass(
                    encoder,
                    StolenClientPipelines.KAWASE_UP_PIPELINE,
                    currentSource,
                    upViews[i],
                    currentWidth,
                    currentHeight,
                    offset,
                    "godweer:kawase_up_" + i
            );
    ...
    private void ensureInitialized() {
        ...
        dummyVertexBuffer = createDummyVertexBuffer("godweer:kawase_dummy_vertex");
