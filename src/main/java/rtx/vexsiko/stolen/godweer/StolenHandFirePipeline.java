...
// STOLEN: auto-generated stub, original file: D:/Downloads/GodWeer/GodWeer/src/main/java/gg/godweer/vse/utils/render/impl/HandFirePipeline.java
// Original package remapped to rtx.vexsiko.stolen.godweer and class HandFirePipeline -> StolenHandFirePipeline
 ...
 *_/
public class StolenHandFirePipeline {
    ...
    public void composite(GpuTextureView target, GpuTextureView scene, GpuTextureView smokeView, GpuTextureView mask, int w, int h, float time, float intensity, float r, float g, float b, float a, float radius, float speed, float flameHeight, float softness, float blurRadius, float smoke, float activity) {
        ...
        try (RenderPass renderPass = encoder.createRenderPass(() -> "godweer:hand_fire", target, OptionalInt.empty())) {
            renderPass.setPipeline(StolenClientPipelines.HAND_FIRE_PIPELINE);
    ...
    private void ensureInitialized() {
        ...
        dummyVertexBuffer = createDummyVertexBuffer("godweer:hand_fire_dummy_vertex");
